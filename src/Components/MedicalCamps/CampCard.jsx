...
const CampCard = ({camp}) => {
    ...
    <div className="px-6 py-4">
        ...
        <FaPeopleGroup />
            ...
            <h1 className="px-2 text-sm">{camp.ParticipantCount}</h1>
        </div>
        ...
        <MdOutlineAttachMoney />
            ...
            <h1 className="px-2 text-sm">{camp.CampFees}</h1>
        </div>
        ...
        <div className="flex items-center mt-4  text-black dark:text-gray-200 text-2xl ">
           ...
           <CiCalendarDate />
            ...
            <h1 className="px-2 text-sm">{camp.Date}</h1>
        </div>
        <div className="flex items-center mt-4 text-black dark:text-gray-200 text-2xl">
            
        <IoIosTime/>
            <h1 className="px-2 text-sm">{camp.Time}</h1>
        </div>
        </div>
