...
const CampCard = () => {
    ...
    <div className="flex items-center px-6 py-3 bg-gray-900">
        ...
        <h1 className="mx-3 text-lg font-semibold text-white">Healthcare</h1>
    </div>
    ...
    <div className="px-6 py-4">
        ...
        <FaPeopleGroup />
            ...
            <h1 className="px-2 text-sm">participant</h1>
        </div>
        ...
        <MdOutlineAttachMoney />
            ...
            <h1 className="px-2 text-sm">fee</h1>
        </div>
        ...
        <IoIosTime/>
            <h1 className="px-2 text-sm">Time</h1>
        </div>
        </div>
